...
save_embedding_projector_files(model, f'/Users/yoshiharatatsuhito/Desktop/T.Yoshihara/計算社会科学/Twitter_congress/整形済みデータ/tensor_flow_projector/vector_file_US_simpson={simpson係数}',f'/Users/yoshiharatatsuhito/Desktop/T.Yoshihara/計算社会科学/Twitter_congress/整形済みデータ/tensor_flow_projector/metadata_file_US_simpson={simpson係数}')
