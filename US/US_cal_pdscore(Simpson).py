...
# print(f'point 1 {datetime.datetime.now() - s}')
...
total_list2 = []
ctotal_list = []
bar = tqdm(total = len(l), colour = 'green')
...
with open(f'/Users/yoshiharatatsuhito/Desktop/T.Yoshihara/計算社会科学/Twitter_congress/整形済みデータ/Embedding/US_EMB_simpson={simpson係数}_real_dict.pkl', "wb") as tf:
    pickle.dump(real_dict,tf)
with open(f'/Users/yoshiharatatsuhito/Desktop/T.Yoshihara/計算社会科学/Twitter_congress/整形済みデータ/Embedding/US_EMB_simpson={simpson係数}_real_dict2.pkl', "wb") as tf:
    pickle.dump(real_dict2,tf)
with open(f'/Users/yoshiharatatsuhito/Desktop/T.Yoshihara/計算社会科学/Twitter_congress/整形済みデータ/Embedding/US_EMB_simpson={simpson係数}_real_dict3.pkl', "wb") as tf:
