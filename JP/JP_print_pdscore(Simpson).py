...
simpson係数 = 0
with open(f'/Users/yoshiharatatsuhito/Desktop/T.Yoshihara/計算社会科学/Twitter_congress/整形済みデータ/Embedding/JP_EMB_simpson={simpson係数}_real_dict.pkl', "rb") as tf:
    real_dict = pickle.load(tf)
with open(f'/Users/yoshiharatatsuhito/Desktop/T.Yoshihara/計算社会科学/Twitter_congress/整形済みデータ/Embedding/JP_EMB_simpson={simpson係数}_real_dict2.pkl', "rb") as tf:
    real_dict2 = pickle.load(tf)
with open(f'/Users/yoshiharatatsuhito/Desktop/T.Yoshihara/計算社会科学/Twitter_congress/整形済みデータ/Embedding/JP_EMB_simpson={simpson係数}_real_dict3.pkl', "rb") as tf:
