...
normal_count係数 = 0
print(f'normal_count係数: {normal_count係数}')
...
filename = '/整形済みデータ/Normal_count(JP).csv'
with open(filename, encoding='utf8', newline='') as f:
    csvreader = csv.reader(f)
    a_b_jt=[]
    for row in csvreader:
...
model.wv.save_word2vec_format(f'/Users/yoshiharatatsuhito/Desktop/T.Yoshihara/計算社会科学/Twitter_congress/整形済みデータ/Embedding/JP_EMB_normal_count={normal_count係数}')
