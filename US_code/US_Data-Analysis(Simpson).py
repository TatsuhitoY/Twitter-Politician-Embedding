...
filename = '/Users/yoshiharatatsuhito/Desktop/T.Yoshihara/計算社会科学/Twitter_congress/整形済みデータ/Simpson(US).csv'
with open(filename, encoding='utf8', newline='') as f:
    csvreader = csv.reader(f)
    a_b_jt=[]
    for row in csvreader:
...
nx.write_gexf(H, f'/Users/yoshiharatatsuhito/Downloads/US_Rep(Simpson={simpson係数}).gexf')
