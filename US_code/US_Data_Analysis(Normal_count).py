...
normal_count係数 = 25000

coefficient_adjust = 50000
...
filename = '/Users/yoshiharatatsuhito/Desktop/T.Yoshihara/計算社会科学/Twitter_congress/整形済みデータ/Normal_count(US).csv'
with open(filename, encoding='utf8', newline='') as f:
    csvreader = csv.reader(f)
    a_b_jt=[]
    for row in csvreader:
...
# nx.write_gexf(H, f'/Users/yoshiharatatsuhito/Downloads/US_Rep(Normal_c={normal_count係数}).gexf')
