...
#Dice係数のファイルから値を取り出す
filename = '/Users/yoshiharatatsuhito/Desktop/T.Yoshihara/計算社会科学/Twitter_congress/整形済みデータ/Dice(US).csv'
with open(filename, encoding='utf8', newline='') as f:
    csvreader = csv.reader(f)
    a_b_jt=[]
    for row in csvreader:
...
nx.write_gexf(H, f'/Users/yoshiharatatsuhito/Downloads/US_Rep(Dice={dice係数}).gexf')
